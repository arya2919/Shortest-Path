# Pune Metro Shortest Path Finder

[Pune Metro]

Welcome to the **Pune Metro Shortest Path Finder** project! This web application is designed to help commuters in Pune find the shortest path between two points on the Pune Metro system. Built using HTML, CSS, and JavaScript, this project employs Dijkstra's algorithm to calculate both the shortest path and the fare for your journey.
...
1. **Open the Application:** Visit our website [here](https://github.com/arya2919/Shortest-Path) to access the Pune Metro Shortest Path Finder.
...
5. **Explore the Map:** You can also explore the Pune Metro system using our interactive map to plan alternative routes or learn more about station locations.
...
We welcome contributions to enhance this project! If you have ideas for new features, spot any issues, or want to improve the code, please feel free to [create an issue](https://github.com/arya2919/Shortest-Patissues) or submit a pull request.
